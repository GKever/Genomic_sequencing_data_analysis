...
do
	...
	"
    bwa-mem2 mem -t 20 ./BWA-MEM2_index/UCSC_mm10.fa.gz "${file/_1.fq.gz/_1_val_1.fq}" "${file/_1.fq.gz/_2_val_2.fq}" > "${file/_1.fq.gz/}.sam"  
    ...
    macs2 callpeak -t "${file/_1.fq.gz/_rmdup}.bam"  -f BAMPE -g mm --SPMR --outdir ./MACS2/"${file/_1.fq.gz/}"/ -n "${file/_1.fq.gz/}" -B -q 0.01 --cutoff-analysis
    
    # echo "开始转格式BDGtoBigWig"
    # bedGraphToBigWig ./MACS2/"${file/_1.fq.gz/}"/"${file/_1.fq.gz/}"_treat_pileup.bdg  ./BWA-MEM2_index/mm10.chrom.sizes ./BigWig/"${file/_1.fq.gz/_convert}".bw
