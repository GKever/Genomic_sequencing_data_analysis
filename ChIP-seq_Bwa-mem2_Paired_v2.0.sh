...
do
    ...
    echo "
	Step3: 使用 bwa-mem2 对处理后的文件进行比对
	"
    bwa-mem2 mem -t 20 ./BWA-MEM2_index/UCSC_hg19.fa.gz "${file/_1.fq.gz/_1_val_1.fq}" "${file/_1.fq.gz/_2_val_2.fq}" > "${file/_1.fq.gz/}.sam"  
    ...
    macs2 callpeak -t "${file/_1.fq.gz/_rmdup}.bam"  -f BAMPE -g hs --SPMR --outdir ./MACS2/"${file/_1.fq.gz/}"/ -n "${file/_1.fq.gz/-SPMR}" -B -q 0.01 --cutoff-analysis
